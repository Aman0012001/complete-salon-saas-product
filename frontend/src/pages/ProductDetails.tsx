...
export default function ProductDetails() {
 ...
 <div className="text-sm text-[#1A1A1A] py-2 px-1">
 ...
 <button className="text-sm text-[#1A1A1A] underline underline-offset-4 decoration-1 opacity-60 hover:opacity-100 transition-opacity mt-2 text-center">
