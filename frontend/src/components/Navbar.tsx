...
const Navbar = () => {
 ...
 key={link.name}
 to={link.href}
 className="text-[16px] lg:text-[0.9rem] font-extrabold tracking-[0.1em] text-black transition-all flex items-center gap-1.5 relative py-1 group"
 >
 {link.name}
 ...
 <button className="text-[16px] lg:text-[0.8rem] font-extrabold tracking-[0.1em] text-black transition-all flex items-center gap-1.5 relative py-1 group outline-none">
 SHOP
 ...
 key={link.name}
 to={link.href}
 className="text-[16px] lg:text-[0.8rem] font-extrabold tracking-[0.1em] text-black transition-all flex items-center gap-1.5 relative py-1 group"
 >
 {link.name}
 <span className="absolute bottom-0 left-0 w-full h-[1.5px] bg-black transform scale-x-0 group-hover:scale-x-100 transition-transform duration-300 ease-out origin-left" />
 </Link>
